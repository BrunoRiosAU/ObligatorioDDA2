...
public class ClienteController {
    ...
    public String altaCliente(@Validated Cliente cliente, BindingResult bindingResult, RedirectAttributes redirect, Model modelo){
    ...
    public String modificarCliente(@PathVariable Integer id, @Validated Cliente cliente, BindingResult bindingResult, RedirectAttributes redirect, Model modelo){
